...
const LINKING_ERROR =
  "Onda 네이티브 모듈('OndaModule')을 찾을 수 없습니다. " +
...
const Onda = {
  ...
  setLogLevel: (level: NonNullable<OndaConfig["logLevel"]>): Promise<void> =>
